      ...
      $.ajax({
        ...
        success: function (html) {
          ...
          if (lineID !== null) {
            ...
            const itemTotalhide = $(html).find(`[data-line-item="${lineID}"]`).find('.cart__total-hide');
            ...
            $(`[data-line-item="${lineID}"]`).find('.cart__total-hide').replaceWith(itemTotalhide);
          ...
          const carttotal = $(html).find('.cart__carttotal-container');
